...
int ncclMinNchannels() {
  int minNchannels = 0;
  if (NCCL_MIN_NRINGS != NCCL_MIN_NRINGS_DEFAULT) minNchannels = NCCL_MIN_NRINGS;
  if (NCCL_MIN_NCHANNELS != NCCL_MIN_NCHANNELS_DEFAULT) minNchannels = NCCL_MIN_NCHANNELS;
...
int ncclMaxNchannels() {
  ...
  if (NCCL_MAX_NRINGS != NCCL_MAX_NRINGS_DEFAULT) maxNchannels = NCCL_MAX_NRINGS;
  if (NCCL_MAX_NCHANNELS != NCCL_MAX_NCHANNELS_DEFAULT) maxNchannels = NCCL_MAX_NCHANNELS;
